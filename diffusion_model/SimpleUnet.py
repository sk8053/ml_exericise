# -*- coding: utf-8 -*-
"""
Created on Fri Oct 28 21:41:59 2022
...
class Block(nn.Module):
    def __init__(self, in_ch, out_ch, time_emb_dim, up=False, last_up = False):
        super().__init__()
        ...
        if up:
            ...
            if last_up == False:
                ...
                self.transform = nn.ConvTranspose2d(out_ch, out_ch, [4,5], 2, 1)
        else:
    ...
    def __init__(self):
        ...
        for i in range(len(up_channels)-1):
            ...
            Block_list.append(Block(up_channels[i], up_channels[i+1], \
                                    time_emb_dim, up=True, last_up= last_up))
